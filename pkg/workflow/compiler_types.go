...
type WorkflowData struct {
	...
	CheckoutEntries       []*CheckoutConfig    // user-specified checkout entries from frontmatter (nil = default behavior)
	CheckoutDisabled      bool                 // if true, skip the default workspace checkout step
}
